...
<response>
<osmp_txn_id>]] .. (request.txn_id and tostring(request.txn_id) or "") .. [[</osmp_txn_id>
<prv_txn>]] .. (request.transaction_id and tostring(request.transaction_id) or "") .. [[</prv_txn>
<sum>]] .. (request.sum and tostring(request.sum) or "") .. [[</sum>
<result>]] .. (tostring(code)) .. [[</result>
<comment>]] .. (request.comment or "") .. [[</comment>
</response>]]
